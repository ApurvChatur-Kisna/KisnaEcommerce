      ...
      <section className="pt-24 bg-inherit">
        <div className="px-12 mx-auto max-w-7xl">
            <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-current md:text-5xl md:tracking-tight">
                ...
                <p className="px-0 mb-8 text-lg text-current md:text-xl lg:px-24">
                ...
                <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                    ...
                    <a href="#_" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-gray-100 text-black rounded-2xl sm:w-auto sm:mb-0">
                        Learn More
