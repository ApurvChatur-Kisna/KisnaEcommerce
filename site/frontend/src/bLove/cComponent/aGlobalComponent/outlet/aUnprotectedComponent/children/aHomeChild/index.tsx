        ...
        <div className="px-12 mx-auto max-w-7xl">
            <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-current md:text-4xl md:tracking-tight">
                    <span >Effortlessly Updated</span> <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-[#1A0F4E] to-[#1A0F4E] dark:from-[#D3CEFE] dark:to-[#D3CEFE] lg:inline">Manage Your eCommerce</span> <span>Store for Maximum Success</span>
                </h1>
                ...
                <div className="mb-4 space-x-0 sm:space-x-2 md:mb-8">
                    <Link to={FullRoute.GlobalRoute.ProtectedRoute.AuthorizationRoute.SidebarRoute.DashboardRoute} className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-[#1A0F4E] bg-[#D3CEFE] rounded-2xl sm:w-auto sm:mb-0">
                        Get Started
                    ...
                    <Link to={FullRoute.GlobalRoute.ProtectedRoute.AuthorizationRoute.SidebarRoute.DashboardRoute} className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-[#1A0F4E] text-[#D3CEFE] rounded-2xl sm:w-auto sm:mb-0">
